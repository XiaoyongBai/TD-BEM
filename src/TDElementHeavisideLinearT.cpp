...
TDElementHeavisideLinearT::TDElementHeavisideLinearT(int type):
		TDElementT(type)
{
	//do nothing
}

TDElementHeavisideLinearT::~TDElementHeavisideLinearT()
{
}


void TDElementHeavisideLinearT::FormGH_Regular()
{
...
void TDElementHeavisideLinearT::FormGH_Singular(int singular)
{
...
void TDElementHeavisideLinearT::SubElement(int singular)
{
...
void TDElementHeavisideLinearT::FormGH_Singular_1(int singular, ShapeFunctionT* Shape,
	...
	for(int q_1=0; q_1<fNQ; q_1++)
	{
		for (int q_2=0; q_2<fNQ; q_2++)
		{
			...
			for(int i=0; i<3;i++)
			{
				for(int j=0; j<3; j++)
				{
					HE_1[i*sd*ennd+sd*singular+j] -= w*J_tri*J*DT_Kelvin[j*sd+i];
					HE_2[i*sd*ennd+sd*singular+j] -= w*J_tri*J*DT_Kelvin[j*sd+i];
				}
			}
...
void TDElementHeavisideLinearT::AssembleSubElement(const int* ids, const double* GE_1, const double* GE_2,
