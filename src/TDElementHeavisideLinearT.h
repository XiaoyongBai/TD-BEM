...
#ifndef TDELEMENTHEAVISIDELINEART_H_
#define TDELEMENTHEAVISIDELINEART_H_

#include "TDElementT.h"

namespace TD_BEM {

class TDElementHeavisideLinearT: public TDElementT {

public:

	TDElementHeavisideLinearT(int type);

	virtual ~TDElementHeavisideLinearT();
